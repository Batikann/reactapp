...
export default function HomepageMain() {
    ...
    return (
        <div id="homepage-main">
            ...
            <p>Calling all nature enthusiasts and ocean lovers! Our community is seeking dedicated volunteers to join us in our future projects focused on ocean trash and sustainability. Together, we will organize beach cleanups, engage in recycling initiatives, and collaborate with local to communites raise awareness about the importance of reducing waste.</p>
            ...
            <div id="info-cards-box">
                {
                    infoCards.map(([num,text,href],i) => 
                        <div className="info-card" id={'#'+href}>
                            ...
                            <a className="see-details-button" href={'/'+text.toLowerCase().split(' ').join('')}>See Details</a>
                        </div>
                    )
                }
                <div id="fast-signup-card">
                    <h3>JOIN AS A VOLUNTEER</h3>
                    <form method="GET" action="/signup" target="_blank" rel="noreferrer" id="fast-signup-form">
                        <label htmlFor="name">
                    ...
                    <div id="sdg-card-box">
                        {
                            [4,13,14,15,17].map(sdg => 
                                <a href={"https://sdgs.un.org/goals/goal"+sdg} className="sdg-card" target="_blank" rel="noreferrer">{"SDG"+sdg}</a>
                            )
                        }
                    </div>
                </div>
                <div id="contributed-others-box">
                    <a href="https://sdgs.un.org/" target="_blank" rel="noreferrer" id="sdg-logo">SDG Logo with link</a>
                    <a href="https://developers.google.com/" target="_blank" rel="noreferrer" id="google-for-devs-logo">Google for Developers Logo with Link</a>
                </div>
